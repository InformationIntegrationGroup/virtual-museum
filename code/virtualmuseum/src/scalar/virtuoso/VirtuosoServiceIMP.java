...
public class VirtuosoServiceIMP  {
    ...
    public HashSet<String> getAllGeneralSubject()
    {
		...
		String query = "select ?label from <http://collection.americanart.si.edu>  where { "
    ...
    public String getImageURIByCollectionURI(String collectionURI)
    {
    	...
    	String query = "select ?imageURI from <http://collection.americanart.si.edu> where { " + "<" + collectionURI
    ...
    public String getGeneralSubjectByCollectionURI(String collectionURI)
    {
    	...
    	String query = "select ?subject from <http://collection.americanart.si.edu> where {  "
    ...
    public String getImageURIByPersonURI(String personURI)
    {
    	...
    	String query = "select ?imageURI from <http://collection.americanart.si.edu> where { " + "<" + personURI
	...
	public  Person getPersonByURI(String URI) {
        ...
        for(String temp:person.getAssociateEventURISet())
        {
			...
			{
				QuerySolution result = results.nextSolution();
				RDFNode s1 = result.get("place");
				if(s1!=null&&s1.toString().trim().length()>0)
				{
					person.addAssociatePlace(s1.toString().trim());
				}
			}
			...
			{
				QuerySolution result = results.nextSolution();
				RDFNode s2 = result.get("placeuri");
