...
public class Work  implements Comparable<Work>{
	...
	public String getMuseumURI() {
		return museumURI;
	}

	public void setMuseumURI(String museumURI) {
		this.museumURI = museumURI;
	}
